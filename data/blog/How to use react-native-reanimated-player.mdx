---
title: How to use react-native-reanimated-player?
date: '2022-2-12'
tags: ['react', 'react-native', 'video player']
draft: false
summary:
images: ['/static/images/player-example.gif']
---
...
<div align="center">
  <blockquote>
    <i>`JSThread` to `JSThread`, `UIThread` to `UIThread`.</i>
  </blockquote>
...
<div align="center">
  <img src="/static/images/player-example.gif" width="30%" />
  <br />
</div>
